...
public class AddDialog extends Dialog implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch(view.getId()) {
            case R.id.wifi_add_dialog_none:
                setCheck(NONE);
                break;
            case R.id.wifi_add_dialog_wep:
                setCheck(WEP);
                break;
            case R.id.wifi_add_dialog_wpa:
                setCheck(WPA);
                break;
            case R.id.wifi_add_dialog_cancle:
                dismiss();
                break;
            case R.id.wifi_add_dialog_connect:
